...
import com.example.service.serviceInterface.LivenessServiceInterface;
...
@Service
public class LivenessServiceImpl implements LivenessServiceInterface {
    @Autowired
    ...
    public Liveness enterLiveness(Liveness liveness) /*throws LivenessServiceException*/ {
...

        {
            ...
            for (int i = 0; i < livenessesList.size() - 1; i++) {
                ...
                if (CheckLivenessIsEmpty.checkLivenessIsEmpty(liveness2) == 0) {
